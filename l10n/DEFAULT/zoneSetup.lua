...
flavor = {
	...
	hotel='WPT 15\nDefensive SAM Site protecting Krasnodars southern flank. Neutralize it to clear a path.',
	maykop='WPT 16\nAirbase to the east. The main staging area of our enemy. Neutralize it to win.',
	india='WPT 17\nFARP south of Kutaisskaya.\nIt will also provide a steady stream of income.'
}
...
radiotower = ZoneCommander:new({zone='Radio Tower', side=1, level=1, upgrades=regularzone, crates=cargoAccepts.general, flavorText=flavor.radiotower})
...
hotel = ZoneCommander:new({zone='Hotel', side=1, level=2, upgrades=specialSAM, crates=cargoAccepts.general, flavorText=flavor.hotel})
maykop = ZoneCommander:new({zone='Maykop', side=1, level=6, upgrades=specialKrasnodar, crates=cargoAccepts.general, flavorText=flavor.maykop, income=2})
india = ZoneCommander:new({zone='India', side=1, level=1, upgrades=regularzone, crates=cargoAccepts.general, flavorText=flavor.india, income=2})

radiotower:addCriticalObject('RadioTower')
...
hotel:addCriticalObject('CommandCenter-2')
india:addCriticalObject('IndiaBuilding1')
india:addCriticalObject('IndiaBuilding2')
...
dispatch = {
	...
	factory={
		...
		GroupCommander:new({name='factory9-hotelsup', mission='supply', targetzone='Hotel'}),
	...
	krasnodar={
		...
		GroupCommander:new({name='kras3-1', mission='supply', targetzone='Hotel'}),
	...
	maykop={
		GroupCommander:new({name='may1', mission='supply', targetzone='Echo'}),
		GroupCommander:new({name='may2', mission='supply', targetzone='Hotel'}),
		GroupCommander:new({name='may3', mission='supply', targetzone='Foxtrot'}),
		GroupCommander:new({name='may4', mission='supply', targetzone='India'}),
		GroupCommander:new({name='may5', mission='attack', targetzone='SAM Site'}),
		GroupCommander:new({name='may6', mission='attack', targetzone='Krymsk'}),
		GroupCommander:new({name='may7', mission='attack', targetzone='Radio Tower'}),
		GroupCommander:new({name='may8', mission='attack', targetzone='Factory'}),
		GroupCommander:new({name='may9', mission='attack', targetzone='Echo'}),
		GroupCommander:new({name='may10', mission='attack', targetzone='Foxtrot'}),
		GroupCommander:new({name='may11', mission='patrol', targetzone='Echo'}),
		GroupCommander:new({name='may12', mission='patrol', targetzone='Delta'}),
		GroupCommander:new({name='may13', mission='patrol', targetzone='Factory'}),
		GroupCommander:new({name='may14', mission='patrol', targetzone='Hotel'}),
		GroupCommander:new({name='may15', mission='patrol', targetzone='Factory'})
	},
	india={
	    GroupCommander:new({name='india1', mission='supply', targetzone='Maykop'}),
		GroupCommander:new({name='india2', mission='supply', targetzone='Krasnodar'}),
		GroupCommander:new({name='india-hotel-supply', mission='supply', targetzone='Hotel', type='surface'}),
		GroupCommander:new({name='india-foxtrot-supply', mission='supply', targetzone='Foxtrot', type='surface'})
	}
...
bc:addConnection("Factory","Hotel")
...
bc:addConnection("Hotel","Maykop")
bc:addConnection("India","Maykop")
bc:addConnection("India","Krasnodar")
bc:addConnection("India","Foxtrot")
bc:addConnection("India","Hotel")
...
india:registerTrigger('captured', showCredIncrease, 'indiacaptured')
...
bc:registerShopItem('redmlrs1fire', 'fire red mlrs', 200, function(sender) 
	local gr = Group.getByName('redmlrs1')
	if gr then
		local targetzones = {'Echo', 'Delta', 'SAM Site', 'Factory', 'Radio Tower', 'Krymsk','Hotel','India'}
		local viabletargets = {}
...
lc = LogisticCommander:new({battleCommander = bc, supplyZones = {'Anapa', 'Krymsk', 'Factory', 'Bravo', 'Echo', 'Carrier Group','India'}})
lc:init()
